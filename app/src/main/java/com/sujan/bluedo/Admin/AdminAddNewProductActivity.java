...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("sellerName","BlueDo");
        productMap.put("sellerAddress","BlueDo @ Sri Lanka.");
        productMap.put("sellerPhone","0777135594");
        productMap.put("sellerEmail","bluedo@gmail.com");
        productMap.put("sID","adminbluedosujan1");
